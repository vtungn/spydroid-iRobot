(function () {
    ...
    function setupEvents() {
		...
		$('#iRoUp').click(function () {
            sendRequest('iRoUp');
        });
		$('#iRoLeft').click(function () {
            sendRequest('iRoLeft');
        });
		$('#iRoRight').click(function () {
            sendRequest('iRoRight');
        });
		$('#iRoDown').click(function () {
            sendRequest('iRoDown');
        });
		$('#iRoConn').click(function () {
            sendRequest('iRoConn');
        });
		$('#iRoStop').click(function () {
            sendRequest('iRoStop');
        });
